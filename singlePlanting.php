        ...
        <div class="contents px-5">
            <div class="row">
                ...
                <div class="col-12 mb-3">
                    ...
                    <hr class="bg-dark my-2" style="margin-right: 420px;">
                    <div class="ms-3" id="layout-body">
                        <p class="h6 mb-1 text-primary">Soil Type:<span class="ms-2 text-dark">Calcisol</span></p>
                        <!-- Dropdown with soil types should be (according to the EU):
                            Arenosol
                            Calcisol
                            Chernozem
                            Fluvisol
                            ...
                            Vertisol
                            -->
                            <!-- Multi-Level Dropdowns for later -->
                            <!-- <div class="dropdown">
                                <button
