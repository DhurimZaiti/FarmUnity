        ...
        <div class="contents">
            <div class="row">
                <div class="col-12 mb-3">
                    <h1 class="h1 mb-3">Add Planting Information</h1>
                </div>
                <div class="col-12">
                    ...
                    <div class="ms-3" id="layout-body">
                        ...
                        <div class="mb-3 row">
                            <label for="area_size" class="col-form-label col-md-3">Planting's area size:</label>
                            <div class="col-md-9 d-flex">
                                <input type="text" name="area_size" class="form-control" id="area_size" value="35">
                                <span class="input-group-text ms-2">ha</span>
                            </div>
                        </div>
                        <div class="mb-3 row">
                    ...
                    <div class="col-12 mb-3 d-flex justify-content-end">
                        ...
                        <a href="addPlantingLogic.php" class="mx-3"><button class="btn btn-primary">Add Planting</button></a>
                    </div>
                </div>
            </div>
        </div>
