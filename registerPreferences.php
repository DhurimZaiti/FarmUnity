        ...
        <div class="row">
            <div class="col-md-6 offset-md-3 mt-5">
                <div class="card bg-light mb-5">
                    <div class="card-body">
                        <h1 class="card-title text-center mb-4">Account Preferences</h1>
                        <form action="preferencesLogic.php" method="POST">
                            <div class="mb-3">
                                <label for="country" class="form-label form-label-sm">Time</label>
