            ...
            <div class="row">
                ...
                <div class="col-12">
                    ...
                    <div class="ms-3" id="layout-body">
                        <p class="h6 mb-1 text-primary">Name:<span class="ms-2 text-dark">Bessie</span></p>
                        <p class="h6 mb-1 text-primary">Species:<span class="ms-2 text-dark">Cow</span></p>
                        ...
                        <p class="h6 mb-1 text-primary">Age:<span class="ms-2 text-dark">3 years, 5 months and 15 days <!-- This is as of 27.8.24 . Please fix this to where the date of birth auto calculates the age of the animal --></span></p>
                        <p class="h6 mb-1 text-primary">Gender:<span class="ms-2 text-dark">Female</span></p>
                    ...
                    <div class="ms-3" id="layout-body">
                        ...
                        <p class="h6 mb-1 text-primary">Weight:<span class="ms-2 text-dark">433kg</span></p>
                    ...
                    <div class="ms-3" id="layout-body">
                        ...
                        <p class="h6 mb-1 text-primary">Vaccination Status:<span class="ms-2 text-dark">Vaccinated</span></p>
                        <p class="h6 mb-1 text-primary">Breeding Season:<span class="ms-2 text-dark">21/2/2023 - 24/5/2023</span></p>
                        <p class="h6 mb-1 text-primary">Reproduction Status:<span class="ms-2 text-dark">Pregenant / Lactating/ Infertile / None</span></p>
                        ...
                        <p class="h6 mb-1 text-primary">Medication Records:<span class="ms-2 text-dark">Ill on the 12.9.2023-19.9.2023 with the common cold. Had Diarrhea on the 15.02.2023 for 4 days.</span></p>
                    </div>
