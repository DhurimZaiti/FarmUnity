    ...
    <script>
        window.onload = function() {
            ...
            for (let i = 0; i < fieldsDataJSON.length; i++) {
                ...
                fieldSize.push(fieldsDataJSON[i]['fieldSize']);
            }
            ...
            function addPolygonControl(name, polygonLayer, fieldId, fieldSize) {
        ...
        `;
            ...
            function loadPolygons() {
                fieldCoordinates.forEach(function(field, index) {
                    ...
                    addPolygonControl(fieldNames[index], polygon, fieldIds[index], fieldSize[index]);
                });
            }
